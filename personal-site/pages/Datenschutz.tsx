...
export default function Datenschutz() {
    return (
        <div className="mx-auto w-3/4 mt-20 h-fit text-center flex flex-col">
            <h1 className="text-5xl py-5">Datenschutz&shy;erkl&auml;rung</h1>
            <h2 className="text-3xl py-3">1. Datenschutz auf einen Blick</h2>
            <h3 className="text-2xl py-3">Allgemeine Hinweise</h3>
            ...
            <h3 className="text-2xl py-3">Datenerfassung auf dieser Website</h3>
            <h4>
            ...
            <h3 className="text-2xl py-3">IONOS</h3>
            <p className="text-left">
            ...
            <h3 className="text-2xl py-3">Datenschutz</h3>
            <p className="text-left">
            ...
            <p className="text-left">
                Kevin Sch&uuml;ler
                <br />
                Olvenstedter Stra&szlig;e 21
                <br />
                39108 Magdeburg
            </p>
            <p className="text-left">
                Telefon: +49 (0) 1626063773
                <br />
            ...
            <h3 className="text-2xl py-3">Speicherdauer</h3>
            <p className="text-left">
            ...
            <Link
                href="/"
                className="rounded-lg border-solid border-slate-200 border-2 p-2 mt-5 hover:border-slate-400 hover:scale-105 hover:text-gray-100 w-60 mx-auto">
                Home
            </Link>
        </div>
    );
